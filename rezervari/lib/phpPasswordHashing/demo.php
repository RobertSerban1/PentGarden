...
if (isset($_POST['password_verify'])){
    ...
    $verified = password_verify($pass, $hash)
        ? 'Hash-ul se potriveste cu parola introdusa'
        : 'Hash-ul nu se potriveste cu parola introdusa';
}
...
<body>
        ...
        <form action="" method="POST">
            ...
            <?php if ($hash): ?>
                <p style="clear:both;">Hash-ul dvs. generat este: <span class="code"><?php echo $hash ?></span></p>
            <?php endif ?>
            <?php if ($time): ?>
                <p> Au luat <?php echo $time ?> secunde pentru a genera acest hash</p>
            <?php endif ?>
        </form>
        ...
        <form action="" method="POST">
            ...
            <?php if ($rehash !== FALSE): ?>
                <p style="clear:both;">Hash-ul dvs. generat <?php echo $rehash ?> trebuie reluat</span></p>
            <?php endif ?>
        </form>
